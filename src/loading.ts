document.addEventListener('DOMContentLoaded', function () {
    const progressBar = document.querySelector('.progress-bar::before') as HTMLElement | null;
    const percentageElement = document.getElementById('percentage') as HTMLElement | null;
    let progress = 0;
